...
// 137. forEach With Maps and Sets
...
// // console.log(
// //   ages.map(calcAverageHumanAge).filter(function (dogAge) {
// //     return dogAge > 18;
// //   })
// // );
// const adults = ages.map(calcAverageHumanAge).filter(function (dogAge) {
//   return dogAge >= 18;
// });

// console.log(adults);

// const calcAverage = function (adults) {
//   let sum = 0;
//   for (const adult of adults) sum += adult;
//   return sum / adults.length;
// };
// console.log(calcAverage(adults));
...
// 8.
const dogsAscend = dogs
  .slice()
  .sort((a, b) => a.recommendedFood - b.recommendedFood);
console.log(dogsAscend);
